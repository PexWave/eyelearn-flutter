...
class VerbPractice extends StatefulWidget {
  const VerbPractice({ Key? key }) : super(key: key);

  @override
  _VerbPracticeState createState() => _VerbPracticeState();
}


class _VerbPracticeState extends State<VerbPractice> with RouteAware {
...
Future<void> getlesson() async {
  ...
  try {
      final response = await http.get(Uri.parse("${apiUrl}/api/practices/grammar/practice-verb"));
