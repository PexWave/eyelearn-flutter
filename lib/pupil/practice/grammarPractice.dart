...
class GrammarPractice extends StatefulWidget {
  const GrammarPractice({ Key? key }) : super(key: key);

  @override
  _GrammarPracticeState createState() => _GrammarPracticeState();
}


class _GrammarPracticeState extends State<GrammarPractice> with RouteAware {
...
Future<void> getlesson() async {
  ...
  if (response.statusCode == 200) {
      ...
      try {
        ...
        await playaudio('assets/guide_speaker/grammar_instructions.mp3',instructionCompleter);
