...
class OralLandingPage extends StatefulWidget {
  const OralLandingPage({ Key? key }) : super(key: key);

  @override
  _OralLandingPageState createState() => _OralLandingPageState();
}


class _OralLandingPageState extends State<OralLandingPage> with RouteAware {
...
Future<void> getlesson(Completer<void> lessonCompleter) async {
  ...
  try {
      final response = await http.get(Uri.parse("${apiUrl}/api/lessons/level 1/oral/L-O-ORAL"));
