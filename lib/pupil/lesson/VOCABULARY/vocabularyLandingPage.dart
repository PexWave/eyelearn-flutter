...
class VocabularyLandingPage extends StatefulWidget {
  const VocabularyLandingPage({ Key? key }) : super(key: key);

  @override
  _VocabularyLandingPageState createState() => _VocabularyLandingPageState();
}


class _VocabularyLandingPageState extends State<VocabularyLandingPage> with RouteAware {
...
Future<void> getlesson(Completer<void> lessonCompleter) async {
  ...
  try {
      final response = await http.get(Uri.parse("${apiUrl}/api/lessons/level 1/vocabulary/L-V-VOCABULARY"));
