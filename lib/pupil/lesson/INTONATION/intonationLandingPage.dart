...
class IntonationLandingPage extends StatefulWidget {
  const IntonationLandingPage({ Key? key }) : super(key: key);

  @override
  _IntonationLandingPageState createState() => _IntonationLandingPageState();
}


class _IntonationLandingPageState extends State<IntonationLandingPage> with RouteAware {
...
Future<void> getlesson(Completer<void> lessonCompleter) async {
  ...
  try {
      final response = await http.get(Uri.parse("${apiUrl}/api/lessons/level 1/intonation/L-I-INTONATION"));
